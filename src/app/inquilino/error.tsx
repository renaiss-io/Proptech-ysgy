...
export default function InquilinoError({
  error,
  reset,
}: {
  ...
  return (
    <div className="bg-white rounded-xl border border-red-200 p-8 text-center max-w-md">
      ...
      <button onClick={reset} className="bg-blue-600 text-white rounded-lg px-4 py-2 text-sm font-medium hover:bg-blue-700">
        Reintentar
      </button>
    </div>
  );
